...
potrawy.`, url: 'sosy-jogurty'  },
    { title: "Przyprawy i dodatki", img: "/przyprawy-dodatki.webp", description: `
Aromatyczne przyprawy i dodatki, które wzbogacą każde danie. Intensywny smak 
i naturalna świeżość.`, url: 'przyprawy-dodatki'  }
  ];
  return (
    <section 
      id="produkty" 
